...
**If you have been using a previous version of AuthzForce, check the** `release notes <https://github.com/authzforce/server/blob/release-10.1.1/CHANGELOG.md#1010>`_ **to know what is changed and what is new.**
